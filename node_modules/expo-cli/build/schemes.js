...
async function getSchemesForIosAsync(projectRoot) {
  try {
    ...
    const configPath = (_getInfoPlistPathFrom = (0, _getInfoPlistPath().getInfoPlistPathFromPbxproj)(projectRoot)) !== null && _getInfoPlistPathFrom !== void 0 ? _getInfoPlistPathFrom : _configPlugins().IOSConfig.Paths.getInfoPlistPath(projectRoot);
